      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-[#A89EC9]">
            {stats.total} {t("dashboard.stats.totalEvents").toLowerCase()} ·{" "}
            {stats.upcoming} {t("dashboard.status.upcoming").toLowerCase()} ·{" "}
            {stats.completed} {t("dashboard.status.completed").toLowerCase()}
          </p>
        </div>
        <button
