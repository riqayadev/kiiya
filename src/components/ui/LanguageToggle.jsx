...
export default function LanguageToggle({ className = "" }) {
  ...
  const inactive = "text-kiiya-dark/60 hover:text-kiiya-primary";

  return (
    <div
      className={`inline-flex items-center gap-1 rounded-full border border-purple-100 bg-white/70 p-1 ${className}`}
    >
      <button
        type="button"
